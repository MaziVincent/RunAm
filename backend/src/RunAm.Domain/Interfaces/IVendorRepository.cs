...
public interface IVendorRepository
{
    ...
    Task<IReadOnlyList<Vendor>> SearchAsync(string? query, Guid? categoryId, int page, int pageSize, CancellationToken ct = default);
    Task<int> GetCountAsync(Guid? categoryId = null, CancellationToken ct = default);
