        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresPhotoProof = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    PricingBreakdown = table.Column<string>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Errands_Users_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Errands_Users_RiderId",
                        column: x => x.RiderId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrandUpdates = table.Column<bool>(type: "boolean", nullable: false),
                    ChatMessages = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RiderLocations_Users_RiderId",
                        column: x => x.RiderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrandCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiderPayouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiderPayouts_Users_RiderId",
                        column: x => x.RiderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundCheckStatus = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_Errands_ErrandId",
                        column: x => x.ErrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ErrandStatusHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ErrandStatusHistory_Errands_ErrandId",
                        column: x => x.ErrandId,
                        principalTable: "Errands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Errands_ErrandId",
                        column: x => x.ErrandId,
                        principalTable: "Errands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ErrandId_CreatedAt",
                table: "ChatMessages",
                columns: new[] { "ErrandId", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Errands_Category",
                table: "Errands",
                column: "Category");

            migrationBuilder.CreateIndex(
                name: "IX_Errands_CreatedAt",
                table: "Errands",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrandStatusHistory_CreatedAt",
                table: "ErrandStatusHistory",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ErrandStatusHistory_ErrandId",
                table: "ErrandStatusHistory",
                column: "ErrandId");

            migrationBuilder.CreateIndex(
                name: "IX_ErrandStops_ErrandId_StopOrder",
                table: "ErrandStops",
                columns: new[] { "ErrandId", "StopOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiderLocations_RecordedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiderPayouts_RiderId_CreatedAt",
                table: "RiderPayouts",
                columns: new[] { "RiderId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_RiderPayouts_Status",
                table: "RiderPayouts",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_RiderProfiles_ApprovalStatus",
                table: "RiderProfiles",
                column: "ApprovalStatus");

            migrationBuilder.CreateIndex(
                name: "IX_RiderProfiles_IsOnline",
                table: "RiderProfiles",
                column: "IsOnline");
